...
def loggedin(username, password, key, name):
    ...
    top_left_frame = tk.Frame(root, bg="white", width=640, height=480)
    top_right_frame = tk.Frame(root, bg="turquoise", width=640, height=480)
    bottom_left_frame = tk.Frame(root, width=640, height=480, bg='pink')
